<?php 
	...
	//wp_body_open hook from WordPress 5.2
		...
		<!-- WRAPPER ALL -->
		<div class="density_tm_wrapper_all" data-border="none" <?php if ( get_header_image() ) : ?> style="background-image:url('<?php header_image(); ?>')";} <?php endif; ?>>
                            ...
                            ?>
								<div class="search_inner">
									<form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="post">
										<div class="search">
											<input type="search" id="s" name="s" placeholder="<?php echo esc_attr__('Search','density-vertical') ?>">
