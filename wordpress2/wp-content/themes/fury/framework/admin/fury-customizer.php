...
// Include Customizer Choices Class File
get_template_part( 'framework/admin/fury-customizer-choices-class' );
 ...
 * @return array
 */
function fury_kirki_configuration_styling( $config ) {
	return wp_parse_args( array(
		'disable_loader' => true
	), $config );
}
add_filter( 'kirki_config', 'fury_kirki_configuration_styling' );
...
if( ! Fury_Helper::is_plugin_active( 'fury-pro/fury-pro.php' ) ) {
...
Kirki::add_field( 'fury_option', [
    ...
    'choices'               => [
        'limit'             => count( FuryCustomizerChoices::socialIcons() ) - 1
    ],
    'fields'                => [
        'media'             => [
            'type'          => 'select',
            ...
            'choices'       => FuryCustomizerChoices::socialIcons(),
        ],
        'url'               => [
            'type'          => 'text',
...
Kirki::add_field( 'fury_option', [
    ...
    'choices'               => [
        'limit'             => count( FuryCustomizerChoices::socialShare() ) - 1
    ],
    'fields'                => [
        'media'             => [
            'type'          => 'select',
            ...
            'choices'       => FuryCustomizerChoices::socialShare(),
        ]
    ]
] );
if( ! Fury_Helper::is_plugin_active( 'fury-pro/fury-pro.php' ) ) {
