<?php
/**
 * Density  Company Theme Customizer
 *
 * @package Density Company
 */
...
for( $i = 1; $i <= $feature_no; $i++ ) {
	...
	$density_featureicon = 'density_page_feature_icon_' . $i;
		...
		$wp_customize->add_control( 
			...
			'description' 		=>  __('Select fontawesome icon from cheatsheet <a target="_blank" href="https://fontawesome.com/v4.7.0/icons/">Icons List</a>','density'),
			'section'  			=> 'features',
			'type'     			=> 'text',
			'priority' 			=> 100,
			)
